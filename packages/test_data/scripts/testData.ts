    ...
    replies: [
      ...
      },
      {
        ...
        replies: [
          ...
          {
            title: '',
            body: "That's great to hear! I've also found that yoga and meditation are helpful for managing stress. Have you tried any specific types of yoga or meditation techniques that you find particularly effective? I've been exploring different styles lately and would love to hear your recommendations.",
            replies: [],
            attestationScheme: AttestationScheme.EIP712,
          },
        ],

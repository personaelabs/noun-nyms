    ...
    <div className="w-full flex justify-between items-center gap-2" onClick={handleClick}>
      <div className="shrink-0 h-min relative">
        <div className="flex gap-2 items-center">
          <div className={`w-2.5 h-2.5 ${n.read ? 'bg-white' : 'bg-blue'} rounded-full`} />
          <UserAvatar userId={n.userId} width={35} />
          <div className="absolute bottom-0 left-full -translate-x-full flex items-center justify-center bg-blue rounded-full p-1 w-[15px] h-[15px]">
            <FontAwesomeIcon
